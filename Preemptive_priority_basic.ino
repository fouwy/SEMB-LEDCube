...
void loadNextImage(int iPlan)
{
    ...
    case 1:
        ...
        I2C_write(PortExpLEFT, OLAT, 0b11111111);
        I2C_write(PortExpCENTER, OLAT + 0x10, 0b11111111);
        I2C_write(PortExpCENTER, OLAT, 0b11111111);
        I2C_write(PortExpRIGHT, OLAT + 0x10, 0b11111111);
        I2C_write(PortExpRIGHT, OLAT, 0b11111111);
        break;
    case 2:
        // Disable "plan
        // Send data to "plan"
    ...
    case 3:
        ...
        I2C_write(PortExpLEFT, OLAT + 0x10, 0b11111111);
        I2C_write(PortExpLEFT, OLAT, 0b11111111);
        I2C_write(PortExpCENTER, OLAT + 0x10, 0b11110011);
        I2C_write(PortExpCENTER, OLAT, 0b11001111);
        I2C_write(PortExpRIGHT, OLAT + 0x10, 0b11111111);
        I2C_write(PortExpRIGHT, OLAT, 0b11111111);
        break;
